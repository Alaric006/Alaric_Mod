package net.alaricj.alaricmod.compat;
...
@JeiPlugin
public class JEIAlaricModPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        List<GemPolishingRecipe> gemPolishingRecipes = recipeManager.getAllRecipesFor(GemPolishingRecipe.Type.INSTANCE);
        registration.addRecipes(GemPolishingCategory.GEM_POLISHING_RECIPE_TYPE, gemPolishingRecipes);
    }
