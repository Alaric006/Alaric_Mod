...
public class ModSounds {
    ...
    public static final ForgeSoundType SOUND_BLOCKS_SOUNDS = new ForgeSoundType(1.0f, 1.0f, SOUND_BLOCK_BREAK, SOUND_BLOCK_STEP, SOUND_BLOCK_PLACE, SOUND_BLOCK_HIT, SOUND_BLOCK_FALL);
